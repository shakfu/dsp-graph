...
from dsp_graph.algebra import _merge_params, _pick_ids
...
class TestOperators:
    def test_rshift_series(self) -> None:
        from dsp_graph.algebra import series as _series  # noqa: F811
    ...
    def test_floordiv_parallel(self) -> None:
        from dsp_graph.algebra import parallel as _par  # noqa: F811
