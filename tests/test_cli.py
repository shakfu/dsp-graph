            ...
            "nodes": [
                {
                    ...
                    "graph": {
                        ...
                        "nodes": [{"id": "lpf", "op": "onepole", "a": "sig", "coeff": "coeff"}],
                    },
                    "inputs": {"sig": "in1"},
                }
            ],
...
class TestSimulate:
    def test_generator_no_inputs(self, tmp_path: Path, capsys: pytest.CaptureFixture[str]) -> None:
    ...
    def test_wav_round_trip(self, tmp_path: Path, capsys: pytest.CaptureFixture[str]) -> None:
        ...
        from dsp_graph.cli import _read_wav
    ...
    def test_param_override(self, tmp_path: Path, capsys: pytest.CaptureFixture[str]) -> None:
    ...
    def test_missing_input_error(self, tmp_path: Path, capsys: pytest.CaptureFixture[str]) -> None:
